...
insert into admin_locations (name, type, parent_id, aliases) values
  ('Universitas Gadjah Mada', 'campus', (select id from admin_locations where name = 'Yogyakarta' and type = 'city'), '{ugm}'),
  ('Universitas Negeri Yogyakarta', 'campus', (select id from admin_locations where name = 'Yogyakarta' and type = 'city'), '{uny}'),
  ('Universitas Muhammadiyah Yogyakarta', 'campus', (select id from admin_locations where name = 'Yogyakarta' and type = 'city'), '{umy}'),
  ('Universitas Islam Indonesia', 'campus', (select id from admin_locations where name = 'Yogyakarta' and type = 'city'), '{uii}'),
  ('Universitas Indonesia', 'campus', (select id from admin_locations where name = 'Depok' and type = 'city'), '{ui}'),
  ('Institut Teknologi Bandung', 'campus', (select id from admin_locations where name = 'Bandung' and type = 'city'), '{itb}'),
  ('Universitas Padjadjaran', 'campus', (select id from admin_locations where name = 'Bandung' and type = 'city'), '{unpad}'),
  ('Universitas Airlangga', 'campus', (select id from admin_locations where name = 'Surabaya' and type = 'city'), '{unair}'),
  ('Universitas Brawijaya', 'campus', (select id from admin_locations where name = 'Malang' and type = 'city'), '{ub}'),
  ('Institut Teknologi Sepuluh Nopember', 'campus', (select id from admin_locations where name = 'Surabaya' and type = 'city'), '{its}'),
  ('IPB University', 'campus', (select id from admin_locations where name = 'Bogor' and type = 'city'), '{ipb}'),
  ('BINUS University Kemanggisan', 'campus', (select id from admin_locations where name = 'Jakarta' and type = 'city'), '{binus}')
on conflict do nothing;

insert into admin_locations (name, type, parent_id, aliases) values
  ('Denpasar', 'area', (select id from admin_locations where name = 'Bali' and type = 'city'), '{}'),
  ('Jimbaran', 'area', (select id from admin_locations where name = 'Bali' and type = 'city'), '{}'),
  ('Kuta', 'area', (select id from admin_locations where name = 'Bali' and type = 'city'), '{}'),
  ('Dago', 'area', (select id from admin_locations where name = 'Bandung' and type = 'city'), '{}'),
  ('Dipatiukur', 'area', (select id from admin_locations where name = 'Bandung' and type = 'city'), '{}'),
  ('Buah Batu', 'area', (select id from admin_locations where name = 'Bandung' and type = 'city'), '{}'),
  ('Sukajadi', 'area', (select id from admin_locations where name = 'Bandung' and type = 'city'), '{}'),
  ('Jatinangor', 'area', (select id from admin_locations where name = 'Bandung' and type = 'city'), '{}'),
  ('Dramaga', 'area', (select id from admin_locations where name = 'Bogor' and type = 'city'), '{}'),
  ('Margonda', 'area', (select id from admin_locations where name = 'Depok' and type = 'city'), '{}'),
  ('Beji', 'area', (select id from admin_locations where name = 'Depok' and type = 'city'), '{}'),
  ('Kukusan', 'area', (select id from admin_locations where name = 'Depok' and type = 'city'), '{}'),
  ('Pondok Cina', 'area', (select id from admin_locations where name = 'Depok' and type = 'city'), '{}'),
  ('Tebet', 'area', (select id from admin_locations where name = 'Jakarta' and type = 'city'), '{}'),
  ('Kuningan', 'area', (select id from admin_locations where name = 'Jakarta' and type = 'city'), '{}'),
  ('Kemang', 'area', (select id from admin_locations where name = 'Jakarta' and type = 'city'), '{}'),
  ('Rawamangun', 'area', (select id from admin_locations where name = 'Jakarta' and type = 'city'), '{}'),
  ('Kemanggisan', 'area', (select id from admin_locations where name = 'Jakarta' and type = 'city'), '{}'),
  ('Lowokwaru', 'area', (select id from admin_locations where name = 'Malang' and type = 'city'), '{}'),
  ('Dinoyo', 'area', (select id from admin_locations where name = 'Malang' and type = 'city'), '{}'),
  ('Tlogomas', 'area', (select id from admin_locations where name = 'Malang' and type = 'city'), '{}'),
  ('Sumbersari', 'area', (select id from admin_locations where name = 'Malang' and type = 'city'), '{}'),
  ('Mulyorejo', 'area', (select id from admin_locations where name = 'Surabaya' and type = 'city'), '{}'),
  ('Sukolilo', 'area', (select id from admin_locations where name = 'Surabaya' and type = 'city'), '{}'),
  ('Rungkut', 'area', (select id from admin_locations where name = 'Surabaya' and type = 'city'), '{}'),
  ('Keputih', 'area', (select id from admin_locations where name = 'Surabaya' and type = 'city'), '{}'),
  ('Kaliurang', 'area', (select id from admin_locations where name = 'Yogyakarta' and type = 'city'), '{}'),
  ('Seturan', 'area', (select id from admin_locations where name = 'Yogyakarta' and type = 'city'), '{}'),
  ('Gejayan', 'area', (select id from admin_locations where name = 'Yogyakarta' and type = 'city'), '{}'),
  ('Pogung', 'area', (select id from admin_locations where name = 'Yogyakarta' and type = 'city'), '{}'),
  ('Babarsari', 'area', (select id from admin_locations where name = 'Yogyakarta' and type = 'city'), '{}')
on conflict do nothing;
...
insert into kos_listings (
  ...
  (102, 'Kos Campur Kaliurang Residence', 'Yogyakarta', 1350000, 4.6, 'Campur', 'Jl. Kaliurang KM 5, Caturtunggal, Sleman, DI Yogyakarta', 'Kos nyaman di kawasan Kaliurang, Yogyakarta, dekat UGM and UNY.', '3.5 x 4 m', 2, 'Pak Andi', 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?auto=format&fit=crop&w=1400&q=85', 'Interior Kos Campur Kaliurang Residence di Kaliurang', false, -7.7557000, 110.3807000),
  ...
  (104, 'Kos Putri Margonda', 'Depok', 1500000, 4.8, 'Putri', 'Jl. Margonda Raya, Beji, Kota Depok, Jawa Barat', 'Kos nyaman di kawasan Margonda, Depok, dekat UI and Gunadarma.', '3.5 x 4 m', 4, 'Pak Andi', 'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&w=900&q=85', 'Interior Kos Putri Margonda di Margonda', false, -6.3728000, 106.8321000),
